...
public class ServerGUI extends JFrame {
    ...
    private void startServer(JLabel statusLabel) {     // dùng Thread // 
        new Thread(() -> {   // LUỒNG MỚI
            try {
                ServerSocket serverSocket = new ServerSocket(PORT); // Lắng nghe client kết nối trên cổng port
