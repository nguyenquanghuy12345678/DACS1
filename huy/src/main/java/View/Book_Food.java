...
public class Book_Food extends JFrame {
    ...
    public Book_Food(Connection connection) {
        ...
        panel.setBackground(new Color(236, 255, 232));
        ...
        lblNewLabel.setFont(new Font("Arial", Font.ITALIC, 27));
        ...
        nameField.setBounds(95, 80, 100, 30);
        panel_1.add(nameField);
        idPhongField = new JTextField();
        idPhongField.setBounds(95, 131, 100, 30);
        panel_1.add(idPhongField);
        nameFoodField = new JTextField();
        nameFoodField.setBounds(95, 183, 100, 30);
        panel_1.add(nameFoodField);
        amountField = new JTextField();
        amountField.setBounds(95, 240, 100, 30);
        panel_1.add(amountField);

        JLabel idOrderLabel = new JLabel("ID Order:");
        idOrderLabel.setBounds(10, 22, 200, 30);
        panel_1.add(idOrderLabel);
        JLabel nameLabel = new JLabel("Name:");
        nameLabel.setBounds(10, 79, 200, 30);
        panel_1.add(nameLabel);
        JLabel idPhongLabel = new JLabel("ID Phòng:");
        idPhongLabel.setBounds(10, 130, 81, 30);
        panel_1.add(idPhongLabel);
        JLabel nameFoodLabel = new JLabel("Name Food:");
        nameFoodLabel.setBounds(10, 182, 81, 30);
        panel_1.add(nameFoodLabel);
        JLabel amountLabel = new JLabel("Amount:");
        amountLabel.setBounds(10, 239, 81, 30);
        panel_1.add(amountLabel);
        
        JLabel lblNewLabel_1 = new JLabel("");
        lblNewLabel_1.setIcon(new ImageIcon("D:\\ICONS\\idcard.png"));
        lblNewLabel_1.setBounds(213, 10, 67, 43);
        panel_1.add(lblNewLabel_1);
        
        JLabel lblNewLabel_1_1 = new JLabel("");
        lblNewLabel_1_1.setIcon(new ImageIcon("D:\\ICONS\\name.png"));
        lblNewLabel_1_1.setBounds(213, 62, 45, 49);
        panel_1.add(lblNewLabel_1_1);
        
        JLabel lblNewLabel_1_2 = new JLabel("");
        lblNewLabel_1_2.setIcon(new ImageIcon("D:\\ICONS\\id.png"));
        lblNewLabel_1_2.setBounds(220, 121, 60, 52);
        panel_1.add(lblNewLabel_1_2);
        
        JLabel lblNewLabel_1_3 = new JLabel("");
        lblNewLabel_1_3.setIcon(new ImageIcon("D:\\ICONS\\food.png"));
        lblNewLabel_1_3.setBounds(213, 183, 67, 47);
        panel_1.add(lblNewLabel_1_3);
        
        JLabel lblNewLabel_1_4 = new JLabel("");
        lblNewLabel_1_4.setIcon(new ImageIcon("D:\\ICONS\\amount.png"));
        lblNewLabel_1_4.setBounds(213, 240, 53, 52);
        panel_1.add(lblNewLabel_1_4);
        
        JLabel lblNewLabel_1_5 = new JLabel("");
        lblNewLabel_1_5.setIcon(new ImageIcon("D:\\ICONS\\order.png"));
        lblNewLabel_1_5.setBounds(34, 320, 61, 43);
        panel_1.add(lblNewLabel_1_5);
        
        JLabel lblNewLabel_1_6 = new JLabel("");
        lblNewLabel_1_6.setIcon(new ImageIcon("D:\\ICONS\\fix.png"));
        lblNewLabel_1_6.setBounds(34, 368, 61, 58);
        panel_1.add(lblNewLabel_1_6);
        
        JLabel lblNewLabel_1_7 = new JLabel("");
        lblNewLabel_1_7.setIcon(new ImageIcon("D:\\ICONS\\xoa.png"));
        lblNewLabel_1_7.setBounds(34, 428, 45, 56);
        panel_1.add(lblNewLabel_1_7);
        
        JLabel lblNewLabel_1_8 = new JLabel("");
        lblNewLabel_1_8.setIcon(new ImageIcon("D:\\ICONS\\in.png"));
        lblNewLabel_1_8.setBounds(34, 507, 61, 46);
        panel_1.add(lblNewLabel_1_8);
        
        JLabel lblNewLabel_2 = new JLabel("");
        lblNewLabel_2.setIcon(new ImageIcon("D:\\ICONS\\star.png"));
        lblNewLabel_2.setBounds(805, 29, 64, 51);
